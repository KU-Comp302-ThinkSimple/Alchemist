...
public class loginSignUpWindow extends JFrame {
	...
	public loginSignUpWindow() {
		setTitle("Welcome to Alchemists!");
		setResizable(false);
		...
		loginFormHeaderText.setFont(new Font("Tahoma", Font.BOLD, 25));
		...
		userNameText.setFont(new Font("Tahoma", Font.BOLD, 25));
		...
		passwordText.setFont(new Font("Tahoma", Font.BOLD, 25));
		...
		backgroundImage.setIcon(new ImageIcon(loginSignUpWindow.class.getResource("/domain/images/login.png")));
