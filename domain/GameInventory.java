...
public class GameInventory implements Serializable {
	...
	public void createMolecule() {
		...
		molecules.add(MoleculeFactory.getInstance().createMolecule(atoms.get(1), atoms.get(4), atoms.get(10)));
		molecules.add(MoleculeFactory.getInstance().createMolecule(atoms.get(3), atoms.get(6), atoms.get(8)));
